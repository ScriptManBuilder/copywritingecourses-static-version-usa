...
const ProductsDropdown: React.FC<ProductsDropdownProps> = ({ 
  ...
  const categories = [
    { id: 1, name: 'Copywriting Basics', icon: '✍️', productId: 1 },
    { id: 2, name: 'Headline Writing', icon: '�', productId: 3 },
    { id: 3, name: 'Sales Copy', icon: '💰', productId: 5 },
    { id: 4, name: 'Email Marketing', icon: '📧', productId: 10 },
    { id: 5, name: 'Advanced Copy', icon: '🏆', productId: 11 }
  ];
  ...
  return (
    ...
    >
      <DropdownContent>
        ...
        <FeaturedSection>
          <FeaturedTitle>Featured Copywriting Courses</FeaturedTitle>
          <ProductGrid>
