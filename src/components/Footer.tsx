  ...
  return (
    <FooterWrapper>
      <FooterContent>
        <FooterMain>
          <FooterSection>
            ...
            <ul>
              ...
              <li><Link to="/products">Copywriting Courses</Link></li>
          ...
          <MoreAboutSection>
            ...
            <PromoCards>
              <PromoCard href="/products">
                <img src="/images/img_1.jpg" alt="Copywriting Courses" />
                <PromoCardContent>
                  <h4>Copywriting Courses</h4>
                  <p>Master Digital Copywriting</p>
                </PromoCardContent>
              </PromoCard>
              ...
              <PromoCard href="/about">
                ...
                <PromoCardContent>
                  <h4>About Us</h4>
                  <p>Copywriting Education Excellence</p>
                </PromoCardContent>
              </PromoCard>
        ...
        <FooterBottom>
          <Copyright>
            Copyright  2025 {COMPANY_INFO.name}. All rights reserved. | Premium Copywriting Education & Training Courses
          </Copyright>
        </FooterBottom>
      </FooterContent>
    </FooterWrapper>
