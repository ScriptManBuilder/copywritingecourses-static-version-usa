    ...
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          the terms and provisions of this agreement. These terms apply to all digital Copywriting courses, educational content, and 
      ...
      <Section>
        ...
        <Paragraph>
          This Copywriting course platform is operated by {COMPANY_INFO.name}. 
      ...
      <Section>
        <SectionTitle>3. Digital Copywriting Course Pricing</SectionTitle>
        <Paragraph>
          Our Copywriting courses are available at the following price points: {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, and {formatPrice(99.99)}. 
      ...
      <Section>
        ...
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "COPYWRITING COURSES" or "COPYWRITING-ECOURSES.COM". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased Copywriting courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All Copywriting course content, including videos, text, images, and downloadable materials, are the intellectual property of 
      ...
      <Section>
        ...
        <Paragraph>
          Due to the digital nature of our Copywriting courses, all sales are final. However, we offer a 7-day satisfaction guarantee. 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our Copywriting course content to reflect the latest developments in digital copywriting. 
