...
const Home: React.FC = () => {
  ...
  const carouselSlides = [
    {
      title: "Why Choose Copywriting Academy?",
      subtitle: "Discover the excellence that makes our copywriting education exceptional"
    },
    {
      title: "Expert-Led Copywriting Training",
      subtitle: "Learn from industry professionals with real-world copywriting and marketing experience"
    },
    {
      title: "Innovation Meets Copywriting",
      subtitle: "Where cutting-edge copywriting techniques meet practical application"
    }
  ];
  ...
  const featuredSlides = [
    {
      title: "Featured Copywriting Courses",
      subtitle: "Discover our most popular and effective copywriting training programs"
    },
    {
      title: "Revolutionary Learning",
      subtitle: "Next-generation copywriting education that transforms careers"
    },
    {
      title: "Premium Copywriting Education",
      subtitle: "Crafted for those who demand excellence in copywriting mastery"
    }
  ];

  // Мемоизируем массив изображений для галереи
  const galleryImages = useMemo(() => {
    // Новые копирайтинговые изображения для галереи
    const allImages = [
      { src: `/images/img_1.jpg`, alt: `Copywriting Portfolio 1`, type: 'copywriting-portfolio' },
      { src: `/images/img_2.jpg`, alt: `Copywriting Portfolio 2`, type: 'copywriting-portfolio' },
      { src: `/images/img_3.jpg`, alt: `Copywriting Portfolio 3`, type: 'copywriting-portfolio' },
      { src: `/images/img_4.jpg`, alt: `Copywriting Portfolio 4`, type: 'copywriting-portfolio' },
      { src: `/images/img_5.jpg`, alt: `Copywriting Portfolio 5`, type: 'copywriting-portfolio' },
      { src: `/images/img_6.jpg`, alt: `Copywriting Portfolio 6`, type: 'copywriting-portfolio' },
      { src: `/images/img_7.jpg`, alt: `Copywriting Portfolio 7`, type: 'copywriting-portfolio' },
      { src: `/images/img_8.jpg`, alt: `Copywriting Portfolio 8`, type: 'copywriting-portfolio' }
    ];
  ...
  const scrollingTexts = useMemo(() => [
    'MASTER PERSUASIVE COPYWRITING TODAY',
    'FOLLOW US @COPYWRITING_ECOURSES',
    'PREMIUM COPYWRITING EDUCATION COURSES',
    'TRANSFORM YOUR CAREER WITH COPYWRITING',
    'SALES COPY & MARKETING CONTENT',
    'JOIN THE COPYWRITING REVOLUTION NOW'
  ], []);
  ...
  return (
    <>
      <HeroSection>
        ...
        <Container>
          <HeroContent>
            <HeroTitle>COPYWRITING E-COURSES</HeroTitle>
            <HeroSubtitle>
              Master Persuasive Writing with Expert-Led Video Courses - Transform Your Marketing Career Today
            </HeroSubtitle>
            <HeroButtons>
        ...
        <Container>
          ...
          <FeaturesGrid>
            <ScrollReveal ref={setScrollRevealRef(1)} delay={100}>
              <FeatureCard>
                <RocketIcon />
                <FeatureTitle>Expert Copywriting Instruction</FeatureTitle>
                <FeatureDescription>
                  Learn from industry professionals with hands-on copywriting and marketing experience and proven track records.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
            ...
            <ScrollReveal ref={setScrollRevealRef(4)} delay={400}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Join hundreds of copywriting enthusiasts worldwide with 24/7 support and community access.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
            ...
            <ScrollReveal ref={setScrollRevealRef(6)} delay={600}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Cutting-edge curriculum updated regularly with the latest copywriting developments and trends.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
          </FeaturesGrid>
      ...
      <VideoSection ref={videoSectionRef}>
        ...
        <VideoSectionContent>
          <VideoSectionTitle>Copywriting Learning in Action</VideoSectionTitle>
          <VideoSectionSubtitle>
            Experience the future of copywriting education through interactive learning and real-world applications
          </VideoSectionSubtitle>
        </VideoSectionContent>
      </VideoSection>
      ...
      <InfoSection>
        <InfoGrid>
          <InfoBlock>
            <InfoTitle>Master Persuasive Copywriting</InfoTitle>
            <InfoDescription>
              Transform your marketing career with comprehensive copywriting training. 
              Learn sales copy, email marketing, content marketing, and advanced copywriting techniques 
              that professionals use to create compelling, conversion-focused content.
            </InfoDescription>
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              Apply copywriting knowledge immediately with practical projects and case studies. 
              Our courses focus on real marketing scenarios and measurable conversion growth in copywriting.
            </InfoDescription>
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              ...
              Stay ahead of the rapidly evolving marketing industry with continuous learning.
            </InfoDescription>
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              Join a thriving community of copywriting professionals and receive personalized guidance. 
              Get answers to your questions and accelerate your marketing learning journey.
            </InfoDescription>
