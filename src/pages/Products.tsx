...
const Products: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: 'Copywriting Basics', name: 'Copywriting Basics' },
    { id: 'Headline Writing', name: 'Headline Writing' },
  ...
  return (
    <ProductsWrapper>
      <Container>
        <PageHeader>
          <PageTitle>Copywriting Learn Collection</PageTitle>
          <PageSubtitle>Master persuasive copywriting with our comprehensive copywriting fundamentals and advanced technique video library</PageSubtitle>
        </PageHeader>
