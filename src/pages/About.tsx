...
const About: React.FC = () => {
  ...
  return (
    <AboutWrapper>
        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('COPYWRITING')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower marketers worldwide with professional copywriting education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform marketing concepts into practical copywriting skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted copywriting courses cover persuasion principles, sales psychology, email marketing, content marketing, and conversion optimization. Each course is designed with hands-on projects, real-world applications, and professional techniques to help you master persuasive copywriting and advance your career in the marketing industry.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Copywriting Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive copywriting learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
        ...
        <Container>
          <StatsContainer>
            <StatsTitle ref={setElementRef(20)}>
              {splitTextToWords('Transforming Careers Through Copywriting Education')}
            </StatsTitle>
            ...
            <StatsGrid>
              <StatCard ref={setElementRef(21)}>
                ...
                <StatDescription>From copywriting beginners to professional marketers across 100+ countries</StatDescription>
              </StatCard>
              ...
              <StatCard ref={setElementRef(23)}>
                ...
                <StatDescription>Leading marketing agencies hiring our copywriting professionals</StatDescription>
              </StatCard>
              ...
              <StatCard ref={setElementRef(25)}>
                ...
                <StatLabel>Copywriting Specializations</StatLabel>
              ...
              <StatCard ref={setElementRef(26)}>
                ...
                <StatDescription>Consistently rated as the top copywriting learning platform</StatDescription>
              </StatCard>
            </StatsGrid>
          </StatsContainer>
        </Container>
      ...
      {/* Copywriting Learning Timeline Section */}
      {/* <TimelineSection>
        <Container>
          <TimelineContainer>
            <SectionTitle ref={setElementRef(12)} style={{ color: '#2d3748' }}>
              {splitTextToLetters('OUR COPYWRITING JOURNEY')}
            </SectionTitle>
            ...
            <Timeline>
              <TimelineItem ref={setElementRef(13)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    CopywritingLearn was founded with a vision to democratize copywriting education 
                    and make copywriting accessible to everyone, from complete beginners to advanced copywriters.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(14)}>
                ...
                <TimelineContent>
                  <TimelineTitle>✍️ First Copywriting Courses</TimelineTitle>
                  <TimelineDescription>
                    Launched our first comprehensive copywriting courses, featuring hands-on projects 
              ...
              <TimelineItem ref={setElementRef(15)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    Established partnerships with leading marketing agencies and copywriting experts 
              ...
              <TimelineItem ref={setElementRef(16)}>
                ...
                <TimelineContent>
                  <TimelineTitle>🚀 Advanced Copywriting Expansion</TimelineTitle>
                  <TimelineDescription>
                    Expanded our course offerings to include advanced copywriting topics: 
                    sales psychology, email marketing, direct response, and conversion optimization.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(17)}>
                ...
                <TimelineContent>
                  <TimelineTitle>🌐 Professional Copywriting Era</TimelineTitle>
                  <TimelineDescription>
                    Pioneered comprehensive professional copywriting courses, 
                    helping students master both direct response and content marketing techniques.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(18)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    ...
                    copywriting education platform by major marketing industry publications.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
              ...
              <TimelineItem ref={setElementRef(19)}>
                ...
                <TimelineContent>
                  ...
                  <TimelineDescription>
                    Continuing to lead copywriting education with emerging techniques, modern copywriting practices, 
                    and innovative learning methodologies for the next generation of copywriters.
                  </TimelineDescription>
                </TimelineContent>
              </TimelineItem>
            </Timeline>
      ...
      {/* Copywriting Education Team Section */}
      <LeadershipSection>
        <Container>
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                ...
                <LeaderInfo>
                  ...
                  <LeaderTitle>Copywriting Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about persuasive copywriting and dedicated to making copywriting education accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of persuasive copywriting.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Copywriting Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in copywriting education, constantly updating 
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Copywriting should be accessible to everyone. We create a supportive environment 
                  where writers from all backgrounds can master persuasive fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Copywriting Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest copywriting tools and platforms, 
                  bringing modern persuasive practices directly to our students.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(32)}>
                ...
                <ValueDescription>
                  Copywriting is an evolving field. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical copywriting skills that you can apply immediately 
                  in real projects, from sales letters to email campaigns and landing pages.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of copywriters with world-class education, 
                practical skills, and real-world projects that drive marketing career success. 
                We believe that by making copywriting education accessible and excellent, we can help 
                students create persuasive marketing content while creating opportunities for everyone 
                to participate in the digital marketing revolution.
              </MissionStatementText>
            </MissionStatement>
          </ValuesContainer>
        </Container>
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            ...
            <ModalSubtitle>Copywriting Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional copywriting experts is dedicated to 
            transforming marketing careers through comprehensive persuasive copywriting education.
            <br /><br />
            We believe copywriting should be accessible to everyone, from complete beginners to advanced copywriters looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex copywriting concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of persuasive copywriting and empower them 
            with the knowledge and skills needed to create compelling marketing content and advance their marketing careers. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately.
            <br /><br />
            Whether you're just starting your copywriting journey or looking to master advanced copywriting techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of persuasive copywriting together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
