...
export const CONTACT_INFO = {
  ...
  phone: process.env.REACT_APP_SUPPORT_PHONE || '+14195154912',
  phoneFormatted: process.env.REACT_APP_SUPPORT_PHONE_FORMATTED || '+1 (419) 515-4912',
} as const;

// Company Information Constants
export const COMPANY_INFO = {
  name: process.env.REACT_APP_COMPANY_NAME || 'Goldleaf Goods LLC',
  websiteUrl: process.env.REACT_APP_WEBSITE_URL || 'copywriting-ecourses.com',
